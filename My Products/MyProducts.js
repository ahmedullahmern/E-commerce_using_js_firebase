...
async function getMyProduces(uid) {
try {
    ...
    querySnapshot.forEach((doc) => {
        ...
        const { images, productName, productPrice, createdBy, Likes, productCategerous } = products
        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-5">
                ...
                <button id = ${doc.id}  class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-5">
